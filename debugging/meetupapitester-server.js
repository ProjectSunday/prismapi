...
function getMarkup() {
	...
	'<a href="https://secure.meetup.com/oauth2/authorize?client_id=sgeirri963sprv1a1vh3r8cp3o&response_type=token&scope=basic+event_management&redirect_uri=http://localhost:7000/authentication" target="_blank">user authorize</a>'
}
